...
const ProductsHome = ({products,AddToCart}) => {
      ...
      <div className="css-treeview" style={{margin: '10px 0px'}}>
        ...
        <ul className="tree-list-pad">
          ...
          {cate.map((category,index)=>(
                ...
                <label htmlFor="item-0">
                  <i className="fa fa-long-arrow-right" aria-hidden="true" />
                  <Link to={`/category/${category.id}`} style={{padding: '0px'}}>{category.name}</Link>
                </label>
              </li>
          ))}
  ...
  <div className="men-pro-item simpleCart_shelfItem">
    <div className="men-thumb-item">
      ...
      {/* <span *ngif="product.productSale!=0" className="product-new-top">%</span> */}
    </div>
...
export default connect(null,mapDispatchToProps)(ProductsHome);
